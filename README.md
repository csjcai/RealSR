...
#### Version 1: 234 scenes (204 scenes for training & 30 scenes for testing), as reported in [the original paper](https://csjcai.github.io/papers/RealSR.pdf) (HR has the same resolution as LR). [Google Drive](https://drive.google.com/open?id=1gKnm9BdgyqISCTDAbGbpVitT-QII_unw) & [Baidu Drive (n77c)](https://pan.baidu.com/s/18OrLbVMg3dCGKUlNrN9uWQ)

#### Version 2: 559 scenes (459 scenes for training & 100 scenes for testing), the extended version (HR has the same resolution as LR). [Google Drive](https://drive.google.com/open?id=1dEBRo_1HH6Yk9zrchEg_JTRi-Uhmd-sj) & [Baidu Drive ()]()
...
#### Version 3: 559 scenes (459 scenes for training & 100 scenes for testing), the extended version (HR and LR have different resolution). [Google Drive](https://drive.google.com/open?id=17ZMjo-zwFouxnm_aFM6CUHBwgRrLZqIM) &[Baidu Drive (2n93)](https://pan.baidu.com/s/1dn4q-7E2_iJkNXx4MPdVng)
