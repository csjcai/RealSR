...
A part of this dataset was used in the image super-resolution (RealSR) challenge in the [NTIRE (in conjunction with CVPR) 2019](http://www.vision.ee.ethz.ch/ntire19/).
