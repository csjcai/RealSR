...
##### Detail for training & testing: Trained on the RGB images and tested on Y channel (images from Version 3). All the results can be downloaded [here](https://drive.google.com/open?id=1OFdreOOP1SeDa5GmssIAF5yaAhjOBRd1).
